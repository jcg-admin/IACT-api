# DICCIONARIO DE PERMISOS - OPCIÓN 3: TARJETAS DETALLADAS
**Sistema IACT - Análisis IVR**
**Versión:** 1.0.0 | **Fecha:** 2026-03-10 | **Modelo RBAC:** v7.0.0 | **Formato:** Tarjetas Individuales por Función
...
- `access.assign` ⚠️ INCOMPATIBLE con `access.revoke`
- **Razón:** Separación de poderes en gestión de permisos

### SoD 2 - user_audit_separation:
- `users.create`, `users.edit`, `users.delete` ⚠️ INCOMPATIBLES con `audit.view`, `audit.search`
- **Razón:** Quien gestiona usuarios NO debe auditar sus propias acciones

### SoD 3 - report_data_separation:
- `reports.modify_data` ⚠️ INCOMPATIBLE con `reports.approve`
- **Razón:** Quien modifica datos NO debe aprobar sus propias modificaciones
...
- **Razón:** Quien crea usuarios NO debe auditar sus propias acciones
...
**Módulo:** MOD_Access - Gestión de Permisos
...
- **Razón:** Quien asigna funciones NO puede revocarlas
...
**Módulo:** MOD_Reports - Reportes y Análisis
**ID Caso de Uso:** UC-017 | **Prioridad:** ALTA | **Frecuencia:** Diaria | **Estado:** Activo

### DESCRIPCIÓN
Permite consultar reportes básicos del sistema IVR con información agregada. Rango máximo **31 días**. Solo lectura (SELECT en BD IVR).
...
- **Razón:** Quien modifica datos NO puede aprobar sus propias modificaciones
...
**Estados de modificación:** pendiente_aprobacion → aprobado / rechazado
...
**Módulo:** MOD_Audit - Auditoría y Compliance
**ID Caso de Uso:** UC-023 | **Prioridad:** ALTA | **Frecuencia:** Semanal | **Estado:** Activo

### DESCRIPCIÓN
Permite consultar registros de auditoría. Rango máximo **90 días**. Solo lectura. Logs se preservan mínimo **7 años**.
...
### DESCRIPCIÓN
⚠️ **FUNCIÓN MUY RESTRINGIDA.** Permite eliminar registros de auditoría bajo circunstancias legales excepcionales. Requiere:
- Justificación legal mínimo **100 caracteres**
- Confirmación con contraseña actual
- Registros deben tener **mínimo 7 años** (CNST-015)
...
*Documento generado: 2026-03-14 13:00:00 UTC*
*Análisis de: DICCIONARIO DE PERMISOS - Sistema IACT v1.0.0*
