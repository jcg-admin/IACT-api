...
class CenterTestData(factory.django.DjangoModelFactory):
    """Factory para Center."""
...
class ServiceTestData(factory.django.DjangoModelFactory):
    ...
    center = factory.SubFactory(CenterTestData)
    activo = True


class CallRecordTestData(factory.django.DjangoModelFactory):
